...
const options = ['ADMIN', 'SEO_PROMOTER', 'SALES', 'ברירת מחדל'];

function DropDownChangeRole(props) {
    const initialSelectedIndex = options.indexOf(props.status);
    ...
    const handleMenuItemClick = (event, index) => {
        ...
        props.onClick(options[index], props.id);
        setOpen(false);
    };
